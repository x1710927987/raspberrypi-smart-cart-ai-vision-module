...
class SmartCartApplication:
    ...
    def __init__(
        ...
        *,
        ...
        self.camera_color_order = camera_color_order
    ...
    def initialize(self) -> bool:
        try:
            ...
            self.camera_source = create_camera_source(
                ...
                color_order=self.camera_color_order,
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        default="bgr",
        help="Actual channel order returned by the camera array before OpenCV processing. Default: bgr.",
    )
